...
<html>
<head>
    <meta http-equiv="memBerDynamicwz-Type" MemBerDynamicwz="text/html; charset=utf-8">
...
<body>
<div style="width:912px;height:670px;position:relative;">
...
<script type="text/javascript">
    ...
    qq.maps.event.addListener(map, "click", function (e) {
        ...
        url3 = encodeURI("http://apis.map.qq.com/ws/geocoder/v1/?location=" + e.latLng.getLat() + "," + e.latLng.getLng() + "&key=DN3BZ-2BY2Q-SR35E-GGXOV-YMFIF-SLFVR&output=jsonp&&callback=?");
    ...
    qq.maps.event.addDomListener(btnSearch, 'click', function () {
        ...
        url = encodeURI("http://apis.map.qq.com/ws/place/v1/search?keyword=" + value + "&boundary=region(" + query_city + ",0)&page_size=9&page_index=1&key=DN3BZ-2BY2Q-SR35E-GGXOV-YMFIF-SLFVR&output=jsonp&&callback=?");
    ...
    city.onclick = function (e) {
        ...
        if (target.className == "city_name") {
            ...
            url2 = encodeURI("http://apis.map.qq.com/ws/geocoder/v1/?region=" + curCity.children[0].innerHTML + "&address=" + curCity.children[0].innerHTML + "&key=DN3BZ-2BY2Q-SR35E-GGXOV-YMFIF-SLFVR&output=jsonp&&callback=?");
    ...
    $(".search_t").autocomplete({
        source:function(request,response){
            url4 = encodeURI("http://apis.map.qq.com/ws/place/v1/suggestion/?keyword=" + request.term + "&region=" + curCity.children[0].innerHTML + "&key=DN3BZ-2BY2Q-SR35E-GGXOV-YMFIF-SLFVR&output=jsonp&&callback=?");
