...
<script type="text/javascript">
        ...
        $("#openAppGrid").sgrid({
            columns:[
                ...
                {field:"id", text:"操作", style:"text-align:center", width: 80, formatter:function(index, content, data){
                    var editUrl = "admin/activity/updateActivitPage?cz=ysj&id=" + content;
                /*    var delUrl = "admin/activity/delActivit/" + content;*/
                    return "<a href='javascript:yl(\""+editUrl+"\");' class='btn btn-xs btn-warning add-tooltip'><i class='glyphicon glyphicon-search'>预览</i></a>"
                         + "&nbsp;<a href='javascript:sj(\""+content+"\");' class='btn btn-xs btn-success add-tooltip'><i class='glyphicon glyphicon-circle-arrow-up'>下架</i></a>"
                /*        + "&nbsp;<a href='javascript:goPage(\""+editUrl+"\");' class='btn btn-xs btn-danger add-tooltip'><i class='glyphicon glyphicon-wrench'>编辑</i></a>";*/
                }}
            ],
            cls: "",
            url: _urlPath + "admin/activity/queryPageysj",
            sort:"id",
            order:"desc",
            pagination:true,
            onLoad:function(){
 ...
 function sj(id) {
     var delUrl = "admin/activity/edit?id="+id+"&state=0";
     showCfm("确定下架该活动吗？", delUrl);
