...
import com.xe.demo.mapper.DynamicwzImgMapper;
 ...
 */
@Service
public class DynamicwzImgService extends AbstratService<DynamicwzImg> {
    @Autowired
    private DynamicwzImgMapper dynamicwzImgMapper;
