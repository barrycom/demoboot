...
public class JavaSmsApi {
    ...
    //通用发送接口的http地址
    private static String URI_SEND_SMS_YP = "http://yunpian.com/v1/sms/send.json";

    private static String URI_SEND_SMS = "http://msg.zalljinfu.com/sms/sendSms";
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        String text = "【汉艺网】您的验证码是3398。如非本人操作，请忽略本短信";

//        Map<String, String> params = new HashMap<String, String>();
//        params.put("appId", apikey);
//        params.put("content", text);
//        params.put("receiver", mobile);
//        System.out.println(post(URI_SEND_SMS, params));

        //String message = JavaSmsApi.sendSms(apikey, text, mobile);
        //发短信调用示例
//        System.out.println(JavaSmsApi.sendSms(apikey, text, mobile));

//        StringMap msg = Json.decode(JavaSmsApi.sendSms(apikey, text, mobile));
//        Object value = msg.get("code");
...
//        System.out.println(JavaSmsApi.sendVoice(apikey, mobile ,code));
     ...
     * @throws IOException
     */
    public static String sendSms(String apikey, String text, String mobile,HttpSession session) throws IOException {
        Map<String, String> params = new HashMap<String, String>();
        params.put("apikey", apikey);
       ...
       // params.put("mobile", mobile);
        ...
        params.put("content", text);
        params.put("receiver", mobile);
        StringMap msg = Json.decode(post(URI_SEND_SMS, params));
        Boolean success = (Boolean)msg.get("success");
        if(success){
            return "发送成功";
        }else{
        	session.setAttribute("SMSSendTime",null);
